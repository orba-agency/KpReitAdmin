<template>
    <div class="main-container">
        <a-card title="Edit Offer" :bordered="false">
            <a-row v-if="message">
            ...
            <a-form-model ref="ruleForm" :model="offer" :rules="rules" :label-col="labelCol" :wrapper-col="wrapperCol">
                <a-form-model-item label="Upload Logo" prop="logo">
                    ...
                    >
                        <img v-if="logoUrl" :src="logoUrl" alt="logo" style="height: 100px;" />
                        <div v-else>
                ...
                >
                    <a-input v-model="offer.short_name" />
                </a-form-model-item>
                ...
                >
                    <a-input v-model="offer.description" type="textarea" />
                </a-form-model-item>
                ...
                >
                    <a-select v-model="offer.type" placeholder="Please select type">
                ...
                >
                    <a-select v-model="offer.asset_type" placeholder="Please select an asset type">
                ...
                >
                    <a-select v-model="offer.currency_id" placeholder="Please select currency" @change="handleCurrency">
                ...
                >
                    <a-input-number v-model="offer.equity_multiple" style="width: 30%;" />
                </a-form-model-item>
                ...
                >
                    <a-input-number v-model="offer.holding_period" style="width: 30%;" />
                </a-form-model-item>
                ...
                >
                    <a-input-number v-model="offer.longitude" style="width: 30%;" />
                </a-form-model-item>
                ...
                >
                    <a-input-number v-model="offer.latitude" style="width: 30%;" />
                </a-form-model-item>
                ...
                >
                    <a-radio-group v-model="offer.status">
                ...
                <a-form-model-item
                    v-for="(fee, index) in offer.fees.slice().reverse()"
                    :key="fee.key"
                    prop="fees"
                    class="item-margin"
                >
                    ...
                    <a-icon
                        v-if="offer.fees.length > 1"
                        class="dynamic-delete-button"
                        type="minus-circle-o"
                        :disabled="offer.fees.length === 1"
                        @click="removeFee(fee)"
                    />
                </a-form-model-item>
    ...
    methods: {
        ...
        handleLogoChange(info) {
            ...
            if (info.file.status === 'done') {
                ...
                this.offer.logo_upload_id = info.file.xhr.id
        ...
        removeFee(item) {
            let index = this.offer.fees.indexOf(item)
            if (index !== -1) {
                this.offer.fees.splice(index, 1)
            }
        },
        addFee() {
            this.offer.fees.push({
                name: '',
                type: 'Flat',
                amount: null,
                key: Date.now(),
